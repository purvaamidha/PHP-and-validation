		...
		<form method="post" action="" enctype="multipart/form-data" name="registration" onSubmit="return formValidation();" id="form">	
            <table class="table">
                <tr>
					...
					<td><input type="text" name="name" required/ value="<?php if(isset($name)){echo $name;} ?>"></td>
                </tr>
				<tr>
                    <td><label for="emailid">Email</label></td>
					<td><input type="email" name="emailid" required/ value="<?php if(isset($emailid)){echo $emailid;} ?>"></td>
                </tr>
                <tr>
